...
For predictive runs, require the metrics' control fingerprint and information-boundary evidence. Forecast MAE, WAPE, quantile coverage and pinball loss are diagnostics unless an explicit versioned SLO declares otherwise; they cannot replace the scheduling SLO.
